...
(function () {
  ...
  class Request {
    ...
    get queryParameters () {
      ...
      for (let i = 0; i < params.length; i++) {
        ...
        resultSet[keypair[0]] = NGN.coalesceb(keypair[1])
      }
  ...
  class Network extends NGN.EventEmitter {
    constructor () {
      ...
      Object.defineProperties(this, {
        // TODO: Remove or make a node-like version
        /**
         * @method xhr
        ...
        // TODO: Check if this is still necessary with ES6 spread op
        /**
         * @method prepend
        ...
        // TODO: Move to nodelike env only
        /**
         * @method getFile
        ...
        // TODO: CDK - though this could be used for server-side template rendering.
